...
public class Project2 
{
	...
	public static void main(String[] args) throws Exception 
	{
		...
		a="C:\\Users\\slk\\Desktop\\Rajgauri Vedpathak\\Google.xls";
		xlRead(a);
		...
		driver.findElement(By.name("q")).sendKeys(xData[i][0]);
		Thread.sleep(2000);
		...
		else
		{
			...
			Files.copy(scrFile, new File("C:\\\\Users\\\\slk\\\\Desktop\\\\Rajgauri Vedpathak\\\\RJ2.jpg"));
			xData[i][5]="C:\\\\\\\\Users\\\\\\\\slk\\\\\\\\Desktop\\\\\\\\Rajgauri Vedpathak\\\\\\\\RJ2.jpg";
		}
		driver.quit();                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
		}
		xlwrite("C:\\\\Users\\\\slk\\\\Desktop\\\\Rajgauri Vedpathak\\\\Result1.xls", xData);
